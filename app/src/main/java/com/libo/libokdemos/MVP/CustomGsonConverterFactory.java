package com.libo.libokdemos.MVP;
...
public class CustomGsonConverterFactory extends Converter.Factory {
    ...
    private class CustomGsonResponseBodyConverter<T> implements Converter<ResponseBody, T> {
        ...
        public T convert(ResponseBody value) throws IOException {
            ...
            Log.e(TAG, "convert: " + split[1]);
            MediaType contentType = value.contentType();
            Charset charset = contentType != null ? contentType.charset(UTF_8) : UTF_8;
            InputStream inputStream = new ByteArrayInputStream(split[1].getBytes());
    ...
    private class CustomGsonRequestBodyConverter<T> implements Converter<T, RequestBody> {
